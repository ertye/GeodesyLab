...
#fig.suptitle('Station UWEV (data smoothed)')
#fig.suptitle('Station NPIT (data smoothed)')
#fig.suptitle('Station CNPK (data smoothed)')
#fig.suptitle('Station BYRL (data smoothed)')
fig.suptitle('Station JOKA (data smoothed)')
